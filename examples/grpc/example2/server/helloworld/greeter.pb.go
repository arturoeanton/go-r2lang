...
const file_greeter_proto_rawDesc = "" +
	...
	"\aGreeter\x12<\n" +
	"\bSayHello\x12\x18.helloworld.HelloRequest\x1a\x16.helloworld.HelloReplyBEZCgithub.com/arturoeanton/go-r2lang/examples/grpc/example2;helloworldb\x06proto3"
