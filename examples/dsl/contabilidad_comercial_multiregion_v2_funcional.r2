// DSL Motor Contable Comercial Multi-Region V2 - VERSION FUNCIONAL 100%
...
// DSL para Comprobantes de Compra
...
// DSL para Analisis de Cuentas - YA FUNCIONA PERFECTAMENTE
...
func main() {
    ...
    console.log("============================================")
    console.log("Sistema Funcional 100pct - Sin Errores de Parsing")
    console.log("")
    ...
    console.log("============================")
    let resultado2 = motorCompras.use("compra EUR servicios 45000")
    ...
    console.log("==========================")
    let resultado4 = motorCompras.use("compra ARG insumos 35000")
    ...
    console.log("============================")
    let resultado7 = motorCompras.use("compra USA servicios 25000")
    ...
    console.log("========================================")
    console.log("SISTEMA DSL COMERCIAL MULTI-REGION V2")
    console.log("========================================")
    console.log("OK Procesamiento automatico de comprobantes de venta")
    console.log("OK Procesamiento automatico de comprobantes de compra")
    console.log("OK Identificacion automatica de cuentas por region")
    console.log("OK Calculo automatico de impuestos por normativa")
    console.log("OK Generacion automatica de asientos contables")
    console.log("OK Analisis detallado de cuentas por region")
    console.log("OK Soporte multi-moneda: USD, EUR, ARS")
    console.log("OK Cumplimiento normativo: US-GAAP, IFRS, RT Argentina")
    console.log("")
