// Sistema Contable LATAM - Con Arrays Arreglados
// Demo para Siigo - Usando asignación por índice

console.log("🌍 Sistema Contable LATAM - Arrays Fixed")
...
// Arrays globales - ahora podemos usar asignación por índice
let transacciones = []
...
func procesarTransaccion(tipo, region, importe) {
    ...
    // Usar asignación por índice gracias al fix
...
func demoConsola() {
    ...
    console.log("  Transacciones: " + std.len(transacciones) + ", Asientos: " + std.len(asientosContables))
