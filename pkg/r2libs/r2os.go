...
func RegisterOS(env *r2core.Environment) {
	...
	env.Set("exit", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
			os.Exit(0)
		}
		code, ok := args[0].(int)
	...
	env.Set("osName", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
	...
	env.Set("currentDir", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		dir, err := os.Getwd()
		if err != nil {
	...
	env.Set("chDir", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	// setEnv(key, value)
	env.Set("setEnv", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 2 {
	...
	env.Set("getEnv", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
			panic("getEnv(key)")
		}
		k, ok := args[0].(string)
	...
	env.Set("envList", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		vars := os.Environ()
	...
	env.Set("listDir", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
			panic("listDir(path)")
		}
		path, ok := args[0].(string)
	...
	env.Set("execCmd", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("runProcess", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("waitProcess", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("killProcess", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
