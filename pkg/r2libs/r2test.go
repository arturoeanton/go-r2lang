...
func RegisterTest(env *r2core.Environment) {
	...
	env.Set("assertEq", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 2 {
	...
	env.Set("assertTrue", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("runAllTests", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
	...
	env.Set("printStep", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
	...
	env.Set("assertEqual", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) != 2 {
