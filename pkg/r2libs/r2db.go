...
func RegisterDB(env *r2core.Environment) {
	// dbConnect(driver, dataSourceName) => connectionId
	env.Set("dbConnect", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 2 {
	...
	// dbQuery(connectionId, query, ...args) => array of maps
	env.Set("dbQuery", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 2 {
	...
	// dbExec(connectionId, query, ...args) => rowsAffected
	env.Set("dbExec", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 2 {
	...
	// dbClose(connectionId) => true
	env.Set("dbClose", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	// dbBegin(connectionId) => transactionId
	env.Set("dbBegin", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	// dbLastInsertId(connectionId, query, ...args) => lastInsertId
	env.Set("dbLastInsertId", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 2 {
	...
	// dbPing(connectionId) => true if connection is alive
	env.Set("dbPing", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	// dbEscape(value) => escaped string for SQL
	env.Set("dbEscape", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	// dbGetConnections() => array of connection IDs
	env.Set("dbGetConnections", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
