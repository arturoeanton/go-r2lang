...
func RegisterHack(env *r2core.Environment) {
	...
	env.Set("hashMD5", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("hashSHA1", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("hashSHA256", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("base64Encode", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("base64Decode", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("portScan", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 3 {
	...
	env.Set("whois", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("hexdump", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("hmacSHA256", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 2 {
	...
	//   - generamos iv random
	env.Set("aesEncrypt", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 2 {
	...
	env.Set("aesDecrypt", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 2 {
	...
	env.Set("dnsLookup", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("dnsLookupAddr", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("simplePing", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("quickRSA", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
	...
	env.Set("rsaEncrypt", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 2 {
	...
	env.Set("rsaDecrypt", r2core.BuiltinFunction(func(args ...interface{}) interface{} {
