...
func RegisterString(env *Environment) {
	// toUpper(str) => STR
	env.Set("toUpper", BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	// toLower(str) => STR
	env.Set("toLower", BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("trim", BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
	...
	env.Set("substring", BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 3 {
	...
	env.Set("indexOf", BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 2 {
	...
	env.Set("lastIndexOf", BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 2 {
	...
	env.Set("startsWith", BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 2 {
	...
	env.Set("endsWith", BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 2 {
	...
	env.Set("replace", BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 3 {
	...
	env.Set("lengthOfString", BuiltinFunction(func(args ...interface{}) interface{} {
		if len(args) < 1 {
